...
Remove-Item -PATH 'C:\Program Files\WindowsApps' -Force -Recurse -Confirm:$false
icacls 'C:\ProgramData\Packages' /grant Administrators:F /t
Remove-Item -PATH 'C:\ProgramData\Packages' -Force -Recurse -Confirm:$false
icacls 'C:\Users\Admin\AppData\Local\Microsoft\WindowsApps' /grant Administrators:F /t
Remove-Item -PATH 'C:\Users\Admin\AppData\Local\Microsoft\WindowsApps' -Force -Recurse -Confirm:$false
taskkill /f /im MicrosoftEdge*
icacls 'C:\Users\Admin\AppData\Local\Packages' /grant Administrators:F /t
Get-ChildItem -LiteralPath C:\Users\Admin\AppData\Local\Packages | Remove-Item -Exclude *StartMenuExperienceHost*,*ShellExperienceHost*,*immersivecontrolpanel*,*Windows.Search*,*OOBENetworkCaptivePortal*,*OOBENetworkConnectionFlow* -Force -Recurse -Confirm:$false
takeown /f 'C:\Windows\SystemApps' /r
icacls 'C:\Windows\SystemApps' /grant Administrators:F /t
Get-ChildItem -LiteralPath C:\Windows\SystemApps | Remove-Item -Exclude *StartMenuExperienceHost*,*ShellExperienceHost*,*immersivecontrolpanel*,*Windows.Search*,*OOBENetworkCaptivePortal*,*OOBENetworkConnectionFlow* -Force -Recurse -Confirm:$false
Get-ChildItem -LiteralPath C:\Windows\SystemApps | Remove-Item -Include *Xbox*,*CBSPreview*,*SecureAssessmentBrowswer*,*SecHealthUI*,*PeopleExperienceHost*,*narratorquickstart*,*CloudExperienceHost*,*ContentDeliveryManager*,*AddSuggestedFoldersToLibraryDialog* -Force -Recurse -Confirm:$false
...
set-service DPS -StartupType Auto
